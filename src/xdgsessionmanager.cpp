    ...
    : QObject(nullptr)
{
    ...
    const QString handleToken = QStringLiteral("kxmlGuiSm_handle");
    const QString sessionHandleToken = QStringLiteral("kxmlGuiSm_session");
...
void XdgSessionManager::onXdgPortalSessionStateChanged(const QDBusObjectPath &sessionHandle, const QVariantMap &state)
{
    ...
    case 2:
        ...
        m_logoutLock.reset(new KSystemInhibitor(i18n("adfasfd"), KSystemInhibitor::Type::Logout, nullptr, nullptr));
        ackQueryEnd();
