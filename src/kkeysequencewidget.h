...
public:
    ...
    /*!
     * \brief Whether multikey shortcuts are allowed.
     */
    bool multiKeyShortcutsAllowed() const;

    /*!
     * \brief Sets whether to accept "plain" keys without modifiers (like Ctrl, Alt, Meta).
     *
    ...
    /*!
     * \brief Sets whether to \a allow modifier-only key sequences.
     * \since 6.1
     */
    void setModifierOnlyAllowed(bool allow);

    /*!
     * \brief Returns whether modifier-only key sequences are allowed.
     * \since 6.1
     */
    ...
    /*!
     * \brief Checks whether the key sequence \a seq is available to grab.
     *
