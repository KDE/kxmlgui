...
public:
...
#if KXMLGUI_ENABLE_DEPRECATED_SINCE(6, 11)
    /**
     ...
     *
     * @deprecated since 6.11, use setPatterns() instead
     */
    KXMLGUI_DEPRECATED_VERSION(6, 11, "Use setPatterns()") void setModifierlessAllowed(bool allow);

    /**
     * @see setModifierlessAllowed()
     *
     * @deprecated since 6.11, use patterns() instead
     */
    KXMLGUI_DEPRECATED_VERSION(6, 11, "Use patterns()") bool isModifierlessAllowed();
     ...
     * @deprecated since 6.11, use setPatterns() instead
     */
    KXMLGUI_DEPRECATED_VERSION(6, 11, "Use setPatterns()") void setModifierOnlyAllowed(bool allow);

    /**
     * @deprecated since 6.11, use patterns() instead
     */
    KXMLGUI_DEPRECATED_VERSION(6, 11, "Use patterns()") bool modifierOnlyAllowed() const;
#endif
